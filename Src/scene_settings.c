...
static int music_volume_percentage = 10;
static int effect_volume_percentage = 10;
...
static void init(){
    ...
    exit_btn = textButton_create(SCREEN_W * 4.0 / 5, SCREEN_H * 4.0 / 5, 100, 50, "EXIT", al_map_rgb(230, 230, 0));
}
